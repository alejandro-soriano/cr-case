...
w_u = 160. #mm
w_l = 50. #mm
num = 15 #Initial dumber of discretization elements
...
#Callback function that handles the input values of the widgets
@app.callback(
...
#Function that updates the app when inputs are varied
